...
const Paste = () => {
    // state.slice.value -> slice_name -> paste and value -> pastes
    const pastes = useSelector((state) => state.paste.pastes)
    const [searchTerm , setSearchTerm] = useState('')
    const dispatch = useDispatch();

    // Searching Logic
    // 1. Coverting the title into LowerCase
    // 2. Coverting the input from searchButton to LowerCase
    // 3. Using Includes finding it.
  ...
  return (
    <div>
      ...
      <div>
        {
          // we need to have each id to be Unique 
          // So Writing Key in button
